...
+ =+pretty= Enables pretty unicode symbols for bullets and priorities,better syntax 
  highlighting for latex and adds a cleaner table. Keep in mind: this can be expensive. If
...
+ =+pretty=
  ...
  + [[https://github.com/Fuco1/org-pretty-table][org-pretty-table]]
+ =+roam=
